...
### (マウスICハンダ付け済み版の場合)
- はんだ付けを始める前に、先の手順を参考にしてトラックボール部分を仮組みして動作確認をしてください
  - キースイッチはトラックボール部周辺に4つほど取り付ければ十分です
  - リセットスイッチや電源スイッチを差し込む必要はありません
    - [レンズを差し込む](#レンズリセットスイッチ電源スイッチを差し込む)
    - [トッププレート、スイッチを取り付ける](#トッププレートスイッチを取り付ける)
    - [トラックボールを取り付ける](#トラックボールを取り付ける)
    - [BLE Micro Proを取り付けて動作確認する](#ble-micro-proを取り付けて動作確認する)
    - [トラックボールを調整する](#トラックボールを調整する)
...
- 写真のようにタブ付きのレンズが同梱されている場合、ニッパーでレンズの両端の一部をカットして、スペーサ及びレンズ左上のスイッチと干渉しないようにしてください
...
- 中身がこぼれないようにボールホルダーをひっくり返し、キーボードにネジ止めします
  - PCBプレートの穴が長穴になっている場合は、穴が縦長になる方向に取り付けます
...
#### トラックボールが反応するように取り付け位置を調整  
  ...
  - 最終手段として、ボールを紙やすり等で軽くやする方法もあるようです。ボールの滑りが悪くならない範囲で試すのもありかもしれません
...
#### レーザーの出力の調整  
  ...
  - CONFIG.JSNの`reserved`の1つ目の数値を調整します。127くらいに下げると反応する場合があるようです。
  - リセットするとレーザーの出力に反映されます。弱すぎても反応しないので、様子を見ながら最適な値を探してください。
